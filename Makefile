...
ROOTNAME=jovero_mark_HW
HW=2
FOPTION=_main
run: jovero_mark_HW1_main.c
	gcc -c echo.c
	gcc -I -g echo.o -Wall -o jovero_mark_HW1_main jovero_mark_HW1_main.c -l wiringPi
	sudo ./jovero_mark_HW1_main
clean:	
	rm jovero_mark_HW1_main
